...
\subsection{Mälud}
\label{sec:m2lud}
Alglaadur puutub kokku kolme tüüpi mäludega, millest ühel voolu kadumisel andmed
kaovad ja kahel andmed säilivad.
...
puhul mälulehti mälulehtedeks (\textit{memory page}), aga STM32F217
...
\begin{itemize}
	\item lubatud ülekirjutamise tsükkleid on rohkem,
